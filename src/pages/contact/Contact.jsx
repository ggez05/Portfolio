            ...
            <section className="contact-section">
                ...
                <form ref={form} className="contact-form" onSubmit={onSubmit}>
                    <div>
                        ...
                        <div>
                            <p>
                                I'm interested in doing an internship and I am always ready to learn new
                                technologies and put hard work into what I do, if you have a job offer for me,
                    ...
                    <div>
                        <footer className="footer">
                            <p> &copy; copyright All Right Reserved Garvit Bhatia - 2022</p>
                        </footer>
                    </div>
                </form>
